...
class TorcsEnv:
    ...
    def step(self, u):
        # convert thisAction to the actual torcs actions
        client = self.client
        ...
        ):  # Episode terminated if agent drives too slow
            if v_long < self.termination_limit_speed:
                print("Too slow")
                episode_terminate = True
                client.R.d["meta"] = True
        ...
        return self.get_obs(), reward, client.R.d["meta"], {}, obs["lastLapTime"]
    ...
    def make_observaton(self, raw_obs):
        if self.vision is False:
            ...
            return Observation(
                ...
                trackPos=np.array(raw_obs["trackPos"], dtype=np.float32) / 1.0,
